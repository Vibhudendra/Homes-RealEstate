...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-2 z-50 w-screen px-4">
      ...
      >
        <div className="flex flex-shrink-0 items-center justify-between">
          <Image
            ...
            alt="logo"
          />
          <span className="text-sm tracking-tight text-white font-semibold">
            Homes
          </span>
        </div>
      ...
      {mobileDrawerOpen && (
        <div className="mt-2 rounded-md bg-black lg:hidden">
          ...
          <div className="w-full flex flex-col items-center justify-center pb-8 py-6 text-white lg:hidden">
            <Button variant="outline" className="mr-2 bg-black">
              Sign in
            </Button>
            <Button className="mt-4 bg-slate-800">Sign up</Button>
          </div>
        </div>
      )}
    </nav>
